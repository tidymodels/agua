...
agua enables users to fit, optimize, and evaluate models via [h2o](H2O) using 
tidymodels syntax. Most users will not have to use aqua directly; the features can be accessed via the new parsnip computational engine `'h2o'`. 
